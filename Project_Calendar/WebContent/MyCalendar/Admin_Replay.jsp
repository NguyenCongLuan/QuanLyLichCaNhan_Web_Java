			  ...
			  <div class="col-sm-8 col-sm-offset-2">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h3 class="panel-title">Trả lời tin nhắn</h3>
					</div>
				...
				<div class="form-group">
					<button id = "btnGui" onclick = "Gui(); return false;" type="submit"  class="btn btn-primary" name="tim" >Gửi</button>			
					<button id = "btnThoat" type="submit" onclick = "Huy(); return false;" class="btn btn-danger" name="huy" value="huy">Hủy</button>
				</div>
			</div>
