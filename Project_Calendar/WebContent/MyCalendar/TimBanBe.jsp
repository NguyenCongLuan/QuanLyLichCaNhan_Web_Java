	...
	<script type="text/javascript">
		...
		/* $.validator.setDefaults( {
			submitHandler: function () {
				$('.alert-success').html('Thêm sự kiện mới thành công! <a href="#" data-dismiss="modal" class="alert-link">Quay lại</a>').removeClass('hide');
...
<body>
	...
	<div class="container ">
			...
			<c:if test="${not empty param.id_email}">
			  ...
			  <div class="col-sm-8 col-sm-offset-2">
				...
				<div class="panel panel-default">
					...
					<!-- <div id ="anhcanhan"><img src="anhdaidien.jpg" alt="avatar"></div> -->
						...
						<div class="form-group">
							<button type="submit" data-toggle="modal" data-target="#myModal_BanBe" class="btn btn-primary" name="luu">Mời tham gia sự kiện</button>			
			   ...
			   <!-- popup -->
				<div id="myModal_BanBe" class="modal fade" role="dialog">
				  <div class="modal-dialog">
					...
					<div class="modal-content">
					  <div class="modal-header">
						...
						<h4 class="modal-title">Tạo mới sự kiện</h4>
					  </div>
					  <div class="modal-body">
					  
						<form id="add_event_user" action = "XuLy_MoiKhachSuKien_jstl.jsp" method="post" class="form-horizontal">
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name = "BaoTruoc" class="form-control" id="sel1">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name = "SoLanLap" class="form-control" id="sel1">
										<option>1</option>
										<option>2</option>
										<option>3</option>
										<option>4</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name = "KhoangThoiGianLap" class="form-control" id="sel1">
										<option>1 giờ</option>
										<option>2 giờ</option>
										<option>3 giờ</option>
										<option>4 giờ</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name = "ChuKyLap" class="form-control" id="sel1">
							...
							<%-- <div class="form-group">
								<label class="col-sm-4 control-label" for="congty">Mời khách</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" value="${row.TenDangNhap}" name = "email" id="email" >
								</div>
							</div> --%>
							
							<input type="hidden" class="form-control" value="${row.Email}" name = "email" id="email" >
