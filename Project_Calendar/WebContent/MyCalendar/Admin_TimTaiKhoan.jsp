...
<tr id = "dong">
	...
	<%-- <td><a href = "XuLy_SuKien_jstl.jsp?id=<c:out value="${row.TenDangNhap}"/>">Sửa</a></td>
	
	onclick="comfirm_decision('<%= allUsers[i].getUserID()%>');"
	<td><a onclick = "Khoa(${row.TenDangNhap}); return false;" href = "" >Xóa</a></td> --%>
