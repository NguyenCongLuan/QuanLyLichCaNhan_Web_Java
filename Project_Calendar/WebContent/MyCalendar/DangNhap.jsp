...
<c:forEach var = "row" items = "${result.rows}">
 ...
 <c:import url="/Servelet_GuiMail?masukien=${row1.MaSuKien}&tensukien=${row1.TenSuKien}&giobatdau=${row1.GioBatDau}&gioketthuc=${row1.GioKetThuc}&ngaybatdau=${row1.NgayBatDau}&ngayketthuc=${row1.NgayKetThuc}&diadiem=${row1.DiaDiem}&mota=${row1.MoTa}&email=${row.Email}&baotruoc=${row1.BaoTruoc}" />
			...
			<div class="col-sm-8 col-sm-offset-2">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="form-login" action="login_jstl.jsp" method="post"  class="form-horizontal" >
							...
							<div class="form-group">
								<label class="col-sm-4 control-label" for="pass">Mật khẩu</label>
								<div class="col-sm-5">
								...
								<div class="col-sm-5 col-sm-offset-4">
									<div class="checkbox">
										<label>
											...
											<b><a data-toggle="modal" data-target="#myModal_forgetPass" id = "quenmatkhau" href = "#">Quên mật khẩu</a></b>
										</label>
									</div>
							...
							<div class="form-group">
								<div class="col-sm-5 col-sm-offset-4">
									<label class="radio-inline">
										...
										<input type="radio" checked = "checked" name="phanquyen" id="user" value="User"> User
										
									</label>
									<label class="radio-inline">
										
										<input type="radio" name="phanquyen" id="admin" value="Admin"> Admin
				  ...
				  <div class="modal-dialog">
					...
					<div class="modal-content">
					  ...
					  <div class="modal-body">
						...
						<form id="signupForm1" action="regis_jstl.jsp" method="post" class="form-horizontal" >
							<div class="form-group">
