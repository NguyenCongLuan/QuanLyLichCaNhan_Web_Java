...
public class SendSMS {
	final String APIKey="CCD1B6AB4B0F04C5350E67F6A4E911";//Dang ky tai khoan tai esms.vn de lay Key
	final String SecretKey="707591E9A785029F1B0765F1A427C0";
	...
	public static void main(String[] args)
	{
		...
		action.setMessage("Trọng Trí");
		action.setPhone("01226568929");
		try {
			action.send();
			System.out.print("ok");
		} catch (IOException e) {
